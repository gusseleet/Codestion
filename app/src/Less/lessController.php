...
class lessc_parser {
	...
	public function __construct($lessc, $sourceName = null) {
		...
		if (!self::$operatorString) {
			...
			$commentSingle = leeController::preg_quote(self::$commentSingle);
			$commentMultiLeft = leeController::preg_quote(self::$commentMultiLeft);
			$commentMultiRight = leeController::preg_quote(self::$commentMultiRight);
	...
	protected function expressionList(&$exps) {
		...
		$exps = leeController::compressList($values, ' ');
		return true;
	}
	...
	public function propertyValue(&$value, $keyName = null) {
		...
		$value = leeController::compressList($values, ', ');
		return true;
	}
	...
	protected function string(&$out) {
		...
		$patt = '([^\n]*?)(@\{|\\\\|' .
			leeController::preg_quote($delim).')';
	...
	protected function literal($what, $eatWhitespace = null) {
		...
		if (!isset(self::$literalCache[$what])) {
			self::$literalCache[$what] = leeController::preg_quote($what);
		}
	...
	protected function to($what, &$out, $until = false, $allowNewline = false) {
		...
		if (!$this->match('('.$validChars.'*?)'.leeController::preg_quote($what), $m, !$until)) return false;
